...
WebUI.setText(findTestObject('Register/inputEmail'), 'meditakurnia@mailsac.com')
...
WebUI.setText(findTestObject('Register/setTextAddress'), '')

WebUI.click(findTestObject('Register/buttonSubmitRegistrasi'))

WebUI.verifyElementPresent(findTestObject('Register/verifyTextAlamatKosong'), 0)
