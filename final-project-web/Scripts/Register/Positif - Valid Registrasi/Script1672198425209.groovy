...
WebUI.setText(findTestObject('Register/setTextUsername'), 'jangukaa')

WebUI.setText(findTestObject('Register/inputEmail'), 'jangukaaa@gmail.com')

WebUI.setText(findTestObject('Register/setTextNoHP'), '08920190131')
...
WebUI.setText(findTestObject('Register/setTextAddress'), 'Jalan Kaca Piring No.12, Jakarta Pusat')

WebUI.click(findTestObject('Register/buttonSubmitRegistrasi'))

WebUI.verifyElementPresent(findTestObject('Register/verifySuksesRegister'), 0)
