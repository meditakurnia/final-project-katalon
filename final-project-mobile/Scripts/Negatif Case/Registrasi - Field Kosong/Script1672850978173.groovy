...
Mobile.setText(findTestObject('Object Repository/Registrasi/setTextFirstName'), '', 0)

Mobile.verifyElementExist(findTestObject('Registrasi/setTextLastNameRegist'), 0)

Mobile.setText(findTestObject('Object Repository/Registrasi/setTextLastNameRegist'), '', 0)

Mobile.verifyElementExist(findTestObject('Registrasi/setTextCountry'), 0)

Mobile.setText(findTestObject('Object Repository/Registrasi/setTextCountry'), '', 0)

Mobile.verifyElementExist(findTestObject('Registrasi/setTextUsernameRegist'), 0)

Mobile.setText(findTestObject('Object Repository/Registrasi/setTextUsernameRegist'), '', 0)
...
Mobile.tap(findTestObject('Registrasi/buttonBackRegist'), 0)

Mobile.verifyElementVisible(findTestObject('Registrasi/buttonCreateProfil'), 0)
